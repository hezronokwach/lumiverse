...
const SignupForm = ({ className })=>{
    ...
    async function onSubmit(values) {
        ...
        const { success, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$authActions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signup"])(formData);
        if (!success) {
            console.log(error);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a5c37f._.js.map